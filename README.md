...
[![Python Versions](https://img.shields.io/pypi/pyversions/pytest-tldr.svg)](https://pypi.python.org/pypi/pytest-tldr)
[![PyPI Version](https://img.shields.io/pypi/v/pytest-tldr.svg)](https://pypi.python.org/pypi/pytest-tldr)
[![Maturity](https://img.shields.io/pypi/status/pytest-tldr.svg)](https://pypi.python.org/pypi/pytest-tldr)
[![BSD License](https://img.shields.io/pypi/l/pytest-tldr.svg)](https://github.com/beeware/pytest-tldr/blob/main/LICENSE)
[![Build Status](https://github.com/beeware/pytest-tldr/workflows/CI/badge.svg?branch=main)](https://github.com/beeware/pytest-tldr/actions)

A [`pytest`](https://pytest.org/) plugin that limits the output of pytest to just the things you need to see.
...
You can install "pytest-tldr" via [`pip`](https://pypi.org/project/pip/) from [PyPI](https://pypi.org):
